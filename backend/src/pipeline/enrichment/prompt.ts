...
2. Distinguish funded R&D projects from the company's
   overall business.
3. Award descriptions and abstracts demonstrate
   technology activity, but do not necessarily describe
   the company's complete product portfolio.
...
7. Explain momentum only using observable signals.
